...
qiniu.conf.ACCESS_KEY = 'e-_jowIUFJpcA9JlEO-VPRUjGQFRQI-MJ9-c4U0f'
qiniu.conf.SECRET_KEY = 'z6bt7l15zt4koRYr-n26sXSGKJN4YV0Tych4-5av'
...
app.post('/admin/storys/new', function (req, res) {
    ...
    story.set('media', req.body.media);
    story.save(null, {
